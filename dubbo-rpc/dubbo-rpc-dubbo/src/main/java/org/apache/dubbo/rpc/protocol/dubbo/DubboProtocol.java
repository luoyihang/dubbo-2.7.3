...
public class DubboProtocol extends AbstractProtocol {
    ...
    private ExchangeHandler requestHandler = new ExchangeHandlerAdapter() {
        ...
        public CompletableFuture<Object> reply(ExchangeChannel channel, Object message) throws RemotingException {
            ...
            // 最后调动 AbstractProxyInvoker.invoke，并且获取返回结果
    ...
    Invoker<?> getInvoker(Channel channel, Invocation inv) throws RemotingException {
        ...
        // 组装成 key， 从 exporterMap 中获取 invoker
        String serviceKey = serviceKey(port, path, inv.getAttachments().get(VERSION_KEY), inv.getAttachments().get(GROUP_KEY));
        // exporterMap 是在 org.apache.dubbo.rpc.protocol.dubbo.DubboProtocol.export 方法中放入的
    ...
    private ExchangeServer createServer(URL url) {
        url = URLBuilder.from(url)
                ...
                .build();
        // 获取当前采用什么样的方式来发布服务，是 netty3、netty4、mina、grizzy
    ...
    public <T> Invoker<T> protocolBindingRefer(Class<T> serviceType, URL url) throws RpcException {
        ...
        // 1. create rpc invoker. 创建 invoker
        // 2. getClients(url) 构建一个通信
    ...
    private ExchangeClient[] getClients(URL url) {
        ...
        if (connections == 0) {
            ...
            // connections = shareconnections == null ? 1 : shareconnections
